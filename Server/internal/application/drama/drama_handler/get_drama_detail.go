...
func GetDramaDetail(httpCtx *gin.Context) {
	req := &drama_model.GetDramaDetailReq{}
	...
	resp, err := drama_service.GetDramaDetail(httpCtx, req.UserID, req.DramaID, req.VIDList, req.PlayInfoType)
	if err != nil {

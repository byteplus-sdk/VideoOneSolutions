...
func AudienceLinkmicFinish(ctx *gin.Context) (resp interface{}, err error) {
	...
	_, err = live_linkmic_api_service.AudienceFinish(ctx, p.AppID, &live_linker_models.ApiAudienceFinishReq{
		HostRoomID: p.RoomID,
		HostUserID: p.UserID,
		OnlyActive: true,
	})

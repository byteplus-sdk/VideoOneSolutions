...
func (eh *EventHandler) AudienceLinkmicLeave(ctx context.Context, param *public.EventParam) (resp interface{}, err error) {
	logs.CtxInfo(ctx, "liveAudienceLinkmicLeave param:%+v", param)
	...
	_, err = live_linkmic_api_service.AudienceLeave(ctx, param.AppID, &live_linker_models.ApiAudienceLeaveReq{

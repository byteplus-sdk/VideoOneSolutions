...
func SwitchFeedStreamRoom(httpCtx *gin.Context) {
	req := &live_feed_model.SwitchFeedStreamRoomReq{}
	...
	resp, err := live_feed_service.SwitchRoom(httpCtx, req.OldRoomID, req.NewRoomID, req.UserID)
	if err != nil {
		logs.CtxError(httpCtx, "SwitchFeedStreamRoom err: %s", err)

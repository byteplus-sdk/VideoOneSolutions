...
func (u *User) IsEnableInvite() bool {
	return u.NetStatus == ktv_db.UserNetStatusOnline && u.InteractStatus == ktv_db.UserInteractStatusNormal && u.SeatID == 0
}
...
func (u *User) IsEnableInteract() bool {
	return u.NetStatus == ktv_db.UserNetStatusOnline && u.InteractStatus == ktv_db.UserInteractStatusInviting || u.InteractStatus == ktv_db.UserInteractStatusApplying
}

func (u *User) IsInteract() bool {
	return u.InteractStatus == ktv_db.UserInteractStatusInteracting
}

func (u *User) IsReconnecting() bool {
	return u.NetStatus == ktv_db.UserNetStatusReconnecting
}

func (u *User) IsOnline() bool {
	return u.NetStatus == ktv_db.UserNetStatusOnline
}

func (u *User) IsHost() bool {
	return u.UserRole == ktv_db.UserRoleHost
}

func (u *User) IsAudience() bool {
	return u.UserRole == ktv_db.UserRoleAudience
}

func (u *User) StartLive() {
	u.NetStatus = ktv_db.UserNetStatusOnline
	u.InteractStatus = ktv_db.UserInteractStatusInteracting
...
func (u *User) LeaveRoom() {
	u.NetStatus = ktv_db.UserNetStatusOffline
	u.InteractStatus = ktv_db.UserInteractStatusNormal
	u.SeatID = 0
...
func (u *User) Disconnect() {
	u.NetStatus = ktv_db.UserNetStatusReconnecting
	u.isDirty = true
}

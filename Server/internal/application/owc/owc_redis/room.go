...
const (
	keyRoomAudienceCountPrefix = "owc:vccontrol:room_audience_count:"
...
func GetAssignedRoomID(ctx context.Context) (int64, error) {
	return redis_cli.Client.Get(ctx, keyAssignedRoomID).Int64()
}

func SetAssignedRoomID(ctx context.Context, roomID int64) {
	redis_cli.Client.Set(ctx, keyAssignedRoomID, roomID, 0)
}

func DelAssignedRoomID(ctx context.Context) {
	redis_cli.Client.Del(ctx, keyAssignedRoomID)
}

...
class SoundEffectsViewController: BaseViewController, ByteRTCEngineDelegate, ByteRTCRoomDelegate {
    ...
    lazy var effectLabel: UILabel = {
        let label = UILabel()
        label.text = getString(key: "effect")
        label.font = UIFont.boldSystemFont(ofSize: 18)
        return label
    }()
    
    lazy var voiceTypeSheetView: ActionSheetView = {
        let actionSheetView = ActionSheetView.init(title: getString(key: "voiceEffect"), optionArray: ["Original","Giant","Chipmunk","Minionst","Vibrato","Robot"], defaultIndex: 0)
    ...
    lazy var voiceReverbSheetView: ActionSheetView = {
        let actionSheetView = ActionSheetView.init(title: getString(key: "reverbEffect"), optionArray: ["Original","Echo","Concert","Ethereal","KTV","Studio","VirtualStereo","Spacious","3D"], defaultIndex: 0)
        actionSheetView.presentingViewController = self
    ...
    lazy var pitchSetting: SliderView = {
        ...
        settingView.title = getString(key: "sandhi")
        return settingView
    }()
    
    lazy var reverbConfigLabel: UILabel = {
        let label = UILabel()
        label.text = getString(key: "reverbConfig")
    ...
    lazy var roomSizeSetting: SliderView = {
        ...
        settingView.title = getString(key: "roomSize")
        return settingView
    }()
    
    lazy var decayTimeSetting: SliderView = {
        let settingView = SliderView(minValue: 0, maxValue: 100, defaultValue: 50)
        settingView.title = getString(key: "voiceTailLength")
        return settingView
    }()
    
    lazy var dampingSetting: SliderView = {
        let settingView = SliderView(minValue: 0, maxValue: 100, defaultValue: 50)
        settingView.title = getString(key: "attenuationDamping")
        return settingView
    }()
    
    lazy var wetGainSetting: SliderView = {
        let settingView = SliderView(minValue: -20, maxValue: 10, defaultValue: 0)
        settingView.title = getString(key: "earlyReflectedSignalStrength")
        return settingView
    }()
    
    lazy var dryGainSetting: SliderView = {
        let settingView = SliderView(minValue: -20, maxValue: 10, defaultValue: 0)
        settingView.title = getString(key: "originalSignalStrength")
        return settingView
    }()
    
    lazy var preDelaySetting: SliderView = {
        let settingView = SliderView(minValue: 0, maxValue: 200, defaultValue: 0)
        settingView.title = getString(key: "earlyReflectedSignalDelay")
        return settingView
    }()
    
    lazy var modifyReverbButton: UIButton = {
        let button = BaseButton()
        button.setTitle(getString(key: "confirmModification"), for: .normal)
    ...
    lazy var ansLabel: UILabel = {
        let label = UILabel()
        label.text = getString(key: "noiseSuppressionMode")
        label.font = effectLabel.font
        return label
    }()
    
    lazy var voiceAnsSheetView: ActionSheetView = {
        let actionSheetView = ActionSheetView.init(title: getString(key: "noiseSuppression"), optionArray: ["Disable","Low","Medium","High","Automatic"], defaultIndex: 0)
        actionSheetView.presentingViewController = self

...
@ApiExample(order = 9.1, name = R.string.title_pull_stream)
    ...
    private void initUI() {
        ...
        btnStartPull.setOnClickListener(v -> {
            ...
            if (TextUtils.isEmpty(url)) {
                ToastUtil.showAlert(PullStreamActivity.this, getString(R.string.toast_url_empty));
                return;
            }

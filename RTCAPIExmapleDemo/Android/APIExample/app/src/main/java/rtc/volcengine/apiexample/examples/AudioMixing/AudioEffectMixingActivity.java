 ...
 * Function brief: If you need to play sound effects during a call and ensure that all members in the room can hear the audio,
 * you will need to use the audio mixing function. This function can combine the audio data captured by the microphone with audio files,
 * PCM audio data, etc. into a single audio stream. The mixed audio stream is then published within the room,
 * allowing all members to hear the combined audio during the call.
 * Notes:
 *  1. For demonstration purposes, all tokens for the functionalities are generated by the client-side TokenGenerator class.
 *  However, please adjust accordingly based on the specific circumstances when integrating in a real environment.
...
public class AudioEffectMixingActivity extends BaseActivity {
    ...
    private void initUI() {
        ...
        // preload
        btnPreload2.setOnClickListener(v -> effectPlayer.preload(EFFECT_ID_2, path2));
        // unload
    ...
    private void initEffectResource() {
        ...
        // 在线url
        path2 = "https://preview.tosound.com:3321/preview?file=freesound/0/137/239241.mp3";
    }

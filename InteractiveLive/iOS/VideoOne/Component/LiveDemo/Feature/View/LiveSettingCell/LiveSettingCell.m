...
- (void)setCellType:(LiveSettingCellType)cellType {
    ...
    switch(cellType) {
        case LiveSettingRTMPullStreaming: {
            self.titleLabel.text = @"RTM pull streaming";
            self.descriptionLabel.text = @"Prioritize ultra-low latency streaming";
            break;
        }
        case LiveSettingRTMPushStreaming: {
            self.titleLabel.text = @"RTM push streaming";
            self.descriptionLabel.text = @"Prioritize ultra-low latency streaming";
            break;
        }
        case LiveSettingABR: {
            self.titleLabel.text = @"ABR";
            self.descriptionLabel.text = @"Prevent users from getting stuck during playback";
            break;
        }
        default:{
            NSLog(@"Set CellType");

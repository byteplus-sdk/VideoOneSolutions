...
- (void)setOnlineUserModel:(LiveUserModel *)onlineUserModel {
    ...
    self.avatarImageView.image = [UIImage imageNamed:onlineUserModel.avatarName bundleName:HomeBundleName subBundleName:AvatarBundleName];
...
- (void)setApplicationUserModel:(LiveUserModel *)applicationUserModel {
    ...
    self.avatarImageView.image = [UIImage imageNamed:applicationUserModel.avatarName bundleName:HomeBundleName subBundleName:AvatarBundleName];
}

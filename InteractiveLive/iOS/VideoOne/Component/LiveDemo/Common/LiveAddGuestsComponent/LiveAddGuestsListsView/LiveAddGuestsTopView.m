...
- (void)tipButtonAction {
    ...
    [[ToastComponent shareToastComponent] showWithMessage:LocalizedString(@"Microphone and camera can only be turned off, the viewing side can be turned on.") block:^(BOOL result) {

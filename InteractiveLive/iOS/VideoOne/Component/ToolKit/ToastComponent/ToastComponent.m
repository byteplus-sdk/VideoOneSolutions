...
- (void)showWithMessage:(NSString *)message view:(UIView *)windowView keep:(BOOL)isKeep block:(void (^)(BOOL result))block {
    [self showWithMessage:message describe:@"" status:ToastViewStatusNone view:windowView keep:isKeep block:block];
}
...
- (void)showWithMessage:(NSString *)message describe:(NSString *)describe status:(ToastViewStatus)status {
    ...
    [self showWithMessage:message describe:describe status:status view:windowVC.view keep:NO block:nil];
}

- (void)showWithMessage:(NSString *)message view:(UIView *)windowView block:(void (^)(BOOL result))block {
    [self showWithMessage:message describe:@"" status:ToastViewStatusNone view:windowView keep:NO block:block];
}

- (void)showWithMessage:(NSString *)message view:(UIView *)windowView {
    [self showWithMessage:message describe:@"" status:ToastViewStatusNone view:windowView keep:NO block:nil];
}

- (void)showWithMessage:(NSString *)message {
    UIViewController *windowVC = [DeviceInforTool topViewController];
    [self showWithMessage:message describe:@"" status:ToastViewStatusNone view:windowVC.view keep:NO block:nil];
}

- (void)showWithMessage:(NSString *)message block:(void (^)(BOOL result))block {
    UIViewController *windowVC = [DeviceInforTool topViewController];
    [self showWithMessage:message describe:@"" status:ToastViewStatusNone view:windowVC.view keep:NO block:block];
}

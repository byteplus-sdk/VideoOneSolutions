...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell setGoAction:^(SceneTableCell *cell, SceneButtonModel * _Nonnull model) {
...
- (void)sceneCell:(SceneTableCell *)cell action:(SceneButtonModel *)model {
...
- (NSMutableArray *)dataArray {
    if (_dataArray == nil) {
        ...
        if (liveDemo) {
            ...
            model.title = LocalizedStringFromBundle(@"interactive_live_scenes", @"App");
            model.des = LocalizedStringFromBundle(@"interactive_live_scenes_des", @"App");
            model.iconNames = @[@"menu_live", @"menu_live1"];

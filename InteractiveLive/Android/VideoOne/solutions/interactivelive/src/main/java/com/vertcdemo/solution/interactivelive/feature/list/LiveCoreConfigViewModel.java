...
public class LiveCoreConfigViewModel extends ViewModel {
    ...
    public MutableLiveData<Boolean> rtmPushStreaming = new MutableLiveData<>(LiveCoreConfig.getRtmPushStreaming());
    ...
    public void setRtmPushStreaming(boolean value) {
        rtmPushStreaming.postValue(value);
        LiveCoreConfig.setRtmPushStreaming(value);
    }

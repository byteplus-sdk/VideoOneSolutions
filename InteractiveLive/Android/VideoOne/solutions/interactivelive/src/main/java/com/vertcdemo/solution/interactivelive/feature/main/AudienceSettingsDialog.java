...
public class AudienceSettingsDialog extends BottomDialogFragmentX {
    ...
    void updateLocalViewStatus() {
        ...
        mBinding.microphoneText.setText(rtcManager.isMicOn() ? R.string.microphone : R.string.microphone_off);
        mBinding.camera.setSelected(rtcManager.isCameraOn());
        mBinding.cameraText.setText(rtcManager.isCameraOn() ? R.string.camera : R.string.camera_off);

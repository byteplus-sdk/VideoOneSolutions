...
object AppExecutors {
    val diskIO: Executor by lazy(LazyThreadSafetyMode.SYNCHRONIZED) { Executors.newSingleThreadExecutor() }
    val networkIO: Executor by lazy(LazyThreadSafetyMode.SYNCHRONIZED) {

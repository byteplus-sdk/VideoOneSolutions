...
import com.byteplus.playerkit.player.cache.CacheException;
...
class CacheTask implements CacheLoader.Task {
    ...
    private void preloadVid(MediaSource source) {
        ...
        L.v(CacheTask.this, "preloadVid", source.getMediaId(), "start", preloadSize);
            ...
            public void preloadItemInfo(PreLoaderItemCallBackInfo info) {
                ...
                switch (key) {
                    ...
                    case PreLoaderItemCallBackInfo.KEY_IS_PRELOAD_END_SUCCEED: {
                        ...
                        if (cacheInfo != null) {
                            Track selected = CacheTask.this.getSelectedTrack(Track.TRACK_TYPE_VIDEO);
                            L.v(CacheTask.this, "preloadVid",
                                    source.getMediaId(),
                                    "success",
                            ...
                            CacheTask.this.setState(STATE_END_FINISHED);
                            CacheTask.this.notifyEndFinishEvent();
                        }
                        break;
                    }
                    case PreLoaderItemCallBackInfo.KEY_IS_PRELOAD_END_FAIL: {
                        ...
                        CacheTask.this.setState(STATE_END_ERROR);
                        CacheTask.this.notifyEndError(info.preloadError);
                        break;
                    }
                    case PreLoaderItemCallBackInfo.KEY_IS_PRELOAD_END_CANCEL: {
                        ...
                        CacheTask.this.setState(STATE_END_STOPPED);
                        CacheTask.this.notifyEndStopped();
                        break;
                    }
                    default: {
                        break;
    ...
    private void preloadUrl(MediaSource source) {
        ...
        L.v(CacheTask.this, "preloadUrl", source.getMediaId(), "start",
                "selected", Track.dump(target),
                "all", Track.dump(source.getTracks()),
                "preloadSize", preloadSize,
                "url", target.getUrl());
    ...
    private void notifyStartEvent() {
        notify(() -> {
            if (mListener != null) {
                mListener.onStart(CacheTask.this);
            }
            for (Listener listener : mDepListeners) {
                listener.onStart(CacheTask.this);
            }
        });
    }
    ...
    private void notifyEndFinishEvent() {
        notify(() -> {
            if (mListener != null) {
                mListener.onFinished(CacheTask.this);
            }

            for (Listener listener : mDepListeners) {
                listener.onFinished(CacheTask.this);
            }
        });
    }
    ...
    private void notifyEndError(Error error) {
        ...
        notify(() -> {
            ...
            if (mListener != null) {
                mListener.onError(CacheTask.this, e);
            }

            for (Listener listener : mDepListeners) {
                listener.onError(CacheTask.this, e);
            }
        });
    }
    ...
    private void notifyEndStopped() {
        notify(() -> {
            if (mListener != null) {
                mListener.onStopped(CacheTask.this);
            }

            for (Listener listener : mDepListeners) {
                listener.onStopped(CacheTask.this);
            }
        });
    }
    ...
    private void preloadModel(MediaSource source) {
        ...
        L.v(CacheTask.this, "preloadModel", source.getMediaId(), "start",
                "selected", Track.dump(target),
                "all", Track.dump(source.getTracks()),
                "preloadSize", preloadSize,
                "url", target.getUrl());
                ...
                switch (key) {
                    case PreLoaderItemCallBackInfo.KEY_IS_PRELOAD_END_SUCCEED: {
                        ...
                        if (cacheInfo != null) {
                            ...
                            Track selected = getSelectedTrack(Track.TRACK_TYPE_VIDEO);
                            L.v(CacheTask.this, "preloadModel",
                                    source.getMediaId(),
                                    "success",
                                    "selected", Track.dump(selected),
                                    "cacheKey", cacheKey,
                    ...
                    case PreLoaderItemCallBackInfo.KEY_IS_PRELOAD_END_FAIL: {
                        ...
                        if (mListener != null) {
                            ...
                            mListener.onError(CacheTask.this, exception);
                        }
                        break;
                    }
                    case PreLoaderItemCallBackInfo.KEY_IS_PRELOAD_END_CANCEL: {

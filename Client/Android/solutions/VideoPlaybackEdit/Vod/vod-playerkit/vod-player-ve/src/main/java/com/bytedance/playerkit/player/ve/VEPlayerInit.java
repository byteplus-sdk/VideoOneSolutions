...
import com.bytedance.playerkit.player.ve.utils.LogLicenseManagerCallback;
...
public class VEPlayerInit {
    ...
    public static void init(Context context,
        ...
        com.bytedance.playerkit.player.cache.CacheLoader.Default.set(new CacheLoader(context, new CacheTask.Factory(context)));

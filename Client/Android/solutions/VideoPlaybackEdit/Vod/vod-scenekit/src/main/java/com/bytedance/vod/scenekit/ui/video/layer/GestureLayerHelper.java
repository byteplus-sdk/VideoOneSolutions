...
import com.bytedance.vod.scenekit.utils.GestureHelper;

import java.lang.ref.WeakReference;

class GestureLayerHelper extends GestureHelper {
    ...
    public GestureLayerHelper(Context context, GestureLayer layer) {
        super(context);
    ...
    public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
        ...
        if (!gestureLayer.isActive(gestureLayer.playScene())) return false;
        ...
        switch (mState) {
            ...
            case STATE_CHANGING_BRIGHTNESS:
                if (gestureLayer.playScene() != PlayScene.SCENE_DETAIL) {

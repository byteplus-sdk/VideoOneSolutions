...
package com.bytedance.voddemo.data.remote.api2.parser;
...
import com.bytedance.playerkit.player.ve.Mapper;
...
public class PlayInfoJson2MediaSourceParser implements Parser<MediaSource> {
    ...
    public static Track playInfo2Track(JSONObject result, JSONObject playInfo) {
        ...
        track.setQuality(Mapper.definition2Quality(trackType, playInfo.optString(trackType == Track.TRACK_TYPE_AUDIO ? "Quality" : "Definition"))); // must set if using {@link com.bytedance.vod.dialog.layer.video.ui.scenekit.QualitySelectDialogLayer}

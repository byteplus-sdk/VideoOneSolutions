...
import static com.bytedance.voddemo.ui.main.MainTabViewModel.TAB_CHANNEL;
import static com.bytedance.voddemo.ui.main.MainTabViewModel.TAB_FEED;
import static com.bytedance.voddemo.ui.main.MainTabViewModel.TAB_MAIN;
import static com.bytedance.voddemo.ui.main.MainTabViewModel.TAB_SETTINGS;
...
import com.bytedance.voddemo.impl.databinding.VevodMainTabFragmentBinding;
import com.bytedance.voddemo.ui.video.scene.feedvideo.FeedVideoFragment;
import com.bytedance.voddemo.ui.video.scene.longvideo.LongVideoFragment;
import com.bytedance.voddemo.ui.video.scene.shortvideo.ShortVideoFragment;
...
public class MainTabFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel.currentTab.observe(getViewLifecycleOwner(), position -> {
            ...
            binding.tabHome.setSelected(position == TAB_MAIN);
            binding.tabHome.setTypeface(position == TAB_MAIN ? bold : normal);

            binding.tabFeed.setSelected(position == TAB_FEED);
            binding.tabFeed.setTypeface(position == TAB_FEED ? bold : normal);

            binding.tabChannel.setSelected(position == TAB_CHANNEL);
            binding.tabChannel.setTypeface(position == TAB_CHANNEL ? bold : normal);

            binding.tabSettings.setSelected(position == TAB_SETTINGS);
            binding.tabSettings.setTypeface(position == TAB_SETTINGS ? bold : normal);
            ...
            if (position == TAB_MAIN || position == TAB_CHANNEL) {
            ...
            if (position == TAB_CHANNEL || position == TAB_SETTINGS) { // light theme
        ...
        binding.tabHome.setOnClickListener(v -> viewModel.currentTab.setValue(TAB_MAIN));
        binding.tabFeed.setOnClickListener(v -> viewModel.currentTab.setValue(TAB_FEED));
        binding.tabChannel.setOnClickListener(v -> viewModel.currentTab.setValue(TAB_CHANNEL));
        binding.tabSettings.setOnClickListener(v -> viewModel.currentTab.setValue(TAB_SETTINGS));

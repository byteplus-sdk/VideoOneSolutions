...
class ByteBufferWrap {
    ...
    // packUint16
    public ByteBufferWrap put(short v) {
        buffer.putShort(v);
        return this;
    }

    public ByteBufferWrap put(byte[] v) {
        put((short) v.length);
        buffer.put(v);
        return this;
    }
    ...
    // packUint32
    public ByteBufferWrap put(int v) {
        buffer.putInt(v);
        return this;
    }

    public ByteBufferWrap put(long v) {
        buffer.putLong(v);
        return this;
    }

    public ByteBufferWrap put(String v) {
        return put(v.getBytes());
    }

    public ByteBufferWrap put(TreeMap<Short, String> extra) {
    ...
    public ByteBufferWrap putIntMap(TreeMap<Short, Integer> extra) {
        put((short) extra.size());

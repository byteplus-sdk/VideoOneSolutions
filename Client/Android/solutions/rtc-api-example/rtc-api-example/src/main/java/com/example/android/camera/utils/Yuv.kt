...
class YuvByteBuffer(image: ImageProxy, dstBuffer: ByteBuffer? = null) {
    @YuvType
    val type: Int
    ...
    private class ImageWrapper(image:ImageProxy) {
    ...
    private class PlaneWrapper(width: Int, height: Int, plane: ImageProxy.PlaneProxy) {
        val width = width
        val height = height

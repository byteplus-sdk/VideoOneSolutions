...
import com.byteplus.minidrama.databinding.VevodMiniDramaDialogCommentLayerBinding;
 ...
 */
public class MDCommentDialogLFragment extends DialogFragment {

    @Override
    public int getTheme() {
        return R.style.VeVodMiniDramaFullscreenDialog;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.vevod_mini_drama_dialog_comment_layer, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        VevodMiniDramaDialogCommentLayerBinding binding = VevodMiniDramaDialogCommentLayerBinding.bind(view);
        ...
        binding.recycler.addItemDecoration(new MDItemSpacerDecoration(context, 0, 8));
        MDCommentItemAdapter adapter = new MDCommentItemAdapter(this, R.layout.vevod_mini_drama_dialog_comment_layer_item, count -> {

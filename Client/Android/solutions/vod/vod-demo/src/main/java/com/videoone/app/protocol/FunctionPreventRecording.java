...
@Keep
public class FunctionPreventRecording implements IFunctionEntry {
    @Override
    public int getTitle() {
        return R.string.vevod_function_prevent_recording_title;
    }
    ...
    public int getDescription() {
        return R.string.vevod_function_prevent_recording_desc;
    }

    @Override
    public void startup(@NonNull Context context) {
        Intent intent = new Intent(context, VodFunctionDispatchActivity.class);
        intent.putExtra(EXTRA_FUNCTION, Function.PREVENT_RECORDING);

...
@Keep
public class FunctionPlaylist implements IFunctionEntry {
    @Override
    public int getTitle() {
        return R.string.vevod_function_playlist_title;
    }

...
package com.byteplus.vod.input.media.views;
...
public class SampleShortVideoAdapter extends RecyclerView.Adapter<SampleShortVideoAdapter.ViewHolder> {
    ...
    SampleShortVideoAdapter(IShortVideoStrategyConfig strategyConfig) {
        mStrategyConfig = strategyConfig;
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public static ViewHolder create(ViewGroup parent, IShortVideoStrategyConfig config) {
            VideoView videoView = createVideoView(parent, config);
    ...
    static VideoView createVideoView(ViewGroup parent, IShortVideoStrategyConfig config) {

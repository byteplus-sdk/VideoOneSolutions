...
@implementation MDSliderControlView
...
- (void)configuratoinCustomView {
    ...
    [self.backView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        switch (self.contentMode) {
            case MDSliderControlViewContentModeCenter:
                make.centerY.equalTo(self);
                break;
            case MDSliderControlViewContentModeTop:
                make.top.equalTo(self);
                break;
            case MDSliderControlViewContentModeBottom:

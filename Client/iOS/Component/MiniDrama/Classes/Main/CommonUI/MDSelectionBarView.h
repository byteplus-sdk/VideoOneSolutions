...
typedef NS_ENUM(NSUInteger, MDSelectionBarViewStyle) {
    MDSelectionBarViewStyleDefault,
    MDSelectionBarViewStyleSelectedLine
};

@class MDSelectionBarView;

typedef void (^ _Nullable MDSelectionBarViewCallback) (MDSelectionBarView * _Nonnull selectionBar, NSUInteger index);

@interface MDSelectionBarView : UIView

/**
 * @abstract Returns the style of the selection bar. (read-only)
 */
@property (nonatomic, readonly) MDSelectionBarViewStyle style;
 ...
 */
@property (nonatomic, copy, nullable) MDSelectionBarViewCallback selectionCallback;

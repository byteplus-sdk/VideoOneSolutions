...
static void *KVOContext_MDSelectionViewController = &KVOContext_MDSelectionViewController;

@interface MDSelectionViewController ()

@property (nonatomic, strong) NSMutableArray *viewControllers;

@end

@implementation MDSelectionViewController {
...
- (void)dealloc {
    [self.scrollView removeObserver:self
                         forKeyPath:NSStringFromSelector(@selector(contentInset))
                            context:KVOContext_MDSelectionViewController];
}
...
- (void)viewDidLoad {
    ...
    [self.scrollView addObserver:self forKeyPath:NSStringFromSelector(@selector(contentInset)) options:0 context:KVOContext_MDSelectionViewController];
}
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary *)change context:(void *)context {
    if (context != KVOContext_MDSelectionViewController) {
...
//@interface MDSelectionViewController (UIStatusBarStyle)
//
//@end
//
//@implementation MDSelectionViewController (UIStatusBarStyle)
//

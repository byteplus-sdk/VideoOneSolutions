...
Pod::Spec.new do |s|
  s.name         = 'MiniDramaWithInStreamAds'
  s.version      = '1.0.0'
  s.summary      = 'MiniDramaWithInStreamAds Scene'
  s.description  = 'MiniDramaWithInStreamAds Scene'
  ...
  s.resource_bundles = {
    'MiniDramaWithInStreamAds' => ['Resources/*.{xcassets,bundle}']
  }
  ...
  s.subspec 'Main' do |subspec|
    ...
    subspec.dependency 'MiniDramaWithInStreamAds/Player'
  ...
  s.subspec 'Entry' do |subspec|
    ...
    subspec.dependency 'MiniDramaWithInStreamAds/Main'
    subspec.dependency 'ToolKit/Common'
  end

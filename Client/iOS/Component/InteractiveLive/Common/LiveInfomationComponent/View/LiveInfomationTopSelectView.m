...
- (BaseButton *)basicButton {
    if (!_basicButton) {
        ...
        [_basicButton setTitle:LocalizedString(@"push_flow_information_title") forState:UIControlStateNormal];
...
- (BaseButton *)realTimeButton {
    if (!_realTimeButton) {
        ...
        [_realTimeButton setTitle:LocalizedString(@"Real-time_information_title") forState:UIControlStateNormal];

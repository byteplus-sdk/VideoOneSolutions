...
- (instancetype)initWithUserList:(NSArray<LiveUserModel *> *)userList {
    ...
    if (self) {
        ...
        self.leftAvatarImageView.image = [UIImage imageNamed:leftUserModel.avatarName bundleName:ToolKitBundleName subBundleName:AvatarBundleName];

        self.rightNameLabel.text = rightUserModel.name;
        self.rightAvatarImageView.image = [UIImage imageNamed:rightUserModel.avatarName bundleName:ToolKitBundleName subBundleName:AvatarBundleName];
    }
    return self;
}

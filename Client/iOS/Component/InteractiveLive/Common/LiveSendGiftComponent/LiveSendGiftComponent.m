...
- (NSArray *)getGiftDataList {
    ...
    model1.giftName = LocalizedString(@"gift_like");
    ...
    model2.giftName = LocalizedString(@"gift_sugar");
    ...
    model3.giftName = LocalizedString(@"gift_diamond");
    ...
    model4.giftName = LocalizedString(@"gift_fireworks");

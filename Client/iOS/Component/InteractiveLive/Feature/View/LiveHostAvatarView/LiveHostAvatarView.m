...
- (void)setHostUserModel:(LiveUserModel *)hostUserModel {
    _hostUserModel = hostUserModel;

    self.avatarView.image = [UIImage imageNamed:hostUserModel.avatarName bundleName:ToolKitBundleName subBundleName:AvatarBundleName];
    self.titleLabel.text = hostUserModel.name;
}

...
- (void)preloadVideoAtIndex:(NSUInteger)index {
    ...
    [[self.playList subarrayWithRange:NSMakeRange(loc, len)] enumerateObjectsUsingBlock:^(BaseVideoModel *obj, NSUInteger idx, BOOL *_Nonnull stop) {
        [VEVideoPlayerController preloadVideoSource:[BaseVideoModel videoEngineVidSource:obj]];
    }];
}

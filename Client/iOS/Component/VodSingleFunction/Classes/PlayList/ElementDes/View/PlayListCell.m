...
- (void)setModel:(BaseVideoModel *)model {
    ...
    [self.videoCoverImageView sd_setImageWithURL:[NSURL URLWithString:model.coverUrl] placeholderImage:[UIImage imageNamed:@"playcover_default" bundleName:@"VodPlayer"]];

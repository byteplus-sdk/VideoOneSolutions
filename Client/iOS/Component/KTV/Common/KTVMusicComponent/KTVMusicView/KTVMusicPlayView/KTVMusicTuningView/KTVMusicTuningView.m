...
static CGFloat DefaultMusicVolume = 10;
...
- (void)reset:(BOOL)isStartMusic {
    ...
    self.musicSlider.value = DefaultMusicVolume;
    self.musicRightLabel.text = @(DefaultMusicVolume).stringValue;
    ...
    [[KTVRTCManager shareRtc] setMusicVolume:DefaultMusicVolume];
    [[KTVRTCManager shareRtc] setRecordingVolume:DefaultVocalVolume];
    [[KTVRTCManager shareRtc] setEarMonitorVolume:DefaultEarVolume];
}
...
- (UILabel *)earLabel {
    if (!_earLabel) {
        ...
        _earLabel.text = LocalizedString(@"label_monitor_mix_title");
...
- (UILabel *)earTipLabel {
    if (!_earTipLabel) {
        ...
        _earTipLabel.text = LocalizedString(@"label_monitor_mix_tip");
...
- (UILabel *)musicLeftLabel {
    if (!_musicLeftLabel) {
        ...
        _musicLeftLabel.text = LocalizedString(@"label_music_volume_title");
...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        ...
        _titleLabel.text = LocalizedString(@"label_audio_tuning_title");
...
- (UILabel *)vocalLeftLabel {
    if (!_vocalLeftLabel) {
        ...
        _vocalLeftLabel.text = LocalizedString(@"label_vocal_volume_title");

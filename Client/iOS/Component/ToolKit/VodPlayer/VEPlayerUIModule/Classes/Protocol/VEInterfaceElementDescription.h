...
typedef enum : NSUInteger {
    ...
    VEInterfaceElementTypeMenuPercentageCell,
    VEInterfaceElementTypeMenuButtonCell,
    ...
    VEInterfaceElementTypeGestureAutoHideController,

    VEInterfaceElementTypeVisual = 3000, // anchor
    VEInterfaceElementTypeMaskView,
    ...
    VEInterfaceElementTypeReplayButton,
 ...
 */
@property (nonatomic, copy) void (^elementWillLayout)(__kindof UIView *, NSSet<UIView *> *, __kindof UIView *);

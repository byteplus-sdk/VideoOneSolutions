...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        middleGuide.imageView.image = [UIImage imageNamed:@"vod_full_screen_video_middle_guide" bundleName:@"VodPlayer"];
        middleGuide.titleLabel.text = LocalizedStringFromBundle(@"full_screen_video_middle_guide_title", @"VodPlayer");
        middleGuide.desLable.text = LocalizedStringFromBundle(@"full_screen_video_middle_guide_des", @"VodPlayer");
        ...
        leftGuide.imageView.image = [UIImage imageNamed:@"vod_full_screen_video_left_guide" bundleName:@"VodPlayer"];
        leftGuide.titleLabel.text = LocalizedStringFromBundle(@"full_screen_video_left_guide_title", @"VodPlayer");
        leftGuide.desLable.text = LocalizedStringFromBundle(@"full_screen_video_left_guide_des", @"VodPlayer");
        ...
        rightGuide.imageView.image = [UIImage imageNamed:@"vod_full_screen_video_right_guide" bundleName:@"VodPlayer"];
        rightGuide.titleLabel.text = LocalizedStringFromBundle(@"full_screen_video_right_guide_title", @"VodPlayer");
        rightGuide.desLable.text = LocalizedStringFromBundle(@"full_screen_video_right_guide_des", @"VodPlayer");

...
- (void)reloadLikeButton {
    self.likeButton.image = [UIImage imageNamed:self.comment.isSelfLiked ? @"vod_liked" : @"vod_like_hollow" bundleName:@"VodPlayer"];
...
- (UIButton *)deleteButton {
    if (!_deleteButton) {
        ...
        [_deleteButton setTitle:LocalizedStringFromBundle(@"delete", @"VodPlayer") forState:UIControlStateNormal];
        [_deleteButton setImage:[UIImage imageNamed:@"vod_delete_14" bundleName:@"VodPlayer"] forState:UIControlStateNormal];

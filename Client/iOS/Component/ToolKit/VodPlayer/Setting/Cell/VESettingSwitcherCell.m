...
#define kABRConfigOpen @"kABRConfigOpen"
...
- (void)switcherValueChanged:(UISwitch *)sender {
    ...
    if (self.settingModel.settingKey == VESettingKeyUniversalABRConfig) {
        [[NSUserDefaults standardUserDefaults] setBool:self.settingModel.open forKey:kABRConfigOpen];

...
- (BaseButton *)leftButton {
    if (!_leftButton) {
        ...
        [_leftButton setImage:[UIImage imageNamed:@"nav_left" bundleName:ToolKitBundleName] forState:UIControlStateNormal];
...
- (UILabel *)navTitleLabel {
    if (!_navTitleLabel) {
        ...
        _navTitleLabel.font = [UIFont systemFontOfSize:17 weight:UIFontWeightMedium];

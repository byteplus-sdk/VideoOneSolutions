...
+ (NSString *)messageFromResponseCode:(RTSStatusCode)code {
    NSString *message = @"";
    NSString *bundleName = ToolKitBundleName;
    switch (code) {
        ...
        case RTSStatusCodeTokenExpired:
            ...
            break;
        case RTSStatusCodeInviteOthersBeingError:
            message = LocalizedStringFromBundle(@"network_message_481", bundleName);
            break;
        ...
        case RTSStatusCodeAudienceApplyOthersHost:
            ...
            break;
        case RTSStatusHostHasReceivedOtherInvitationError:
            message = LocalizedStringFromBundle(@"network_message_634", bundleName);
            break;

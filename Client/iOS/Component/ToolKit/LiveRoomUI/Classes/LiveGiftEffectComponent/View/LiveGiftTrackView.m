...
- (instancetype)initWithModel:(LiveGiftEffectModel *)model withDuration:(float)duration {
    ...
    if (self) {
        ...
        self.giftIconView.image = [UIImage imageNamed:model.giftIcon bundleName:@"LiveRoomUI"];
...
- (UIImageView *)trackContentView {
    if (!_trackContentView) {
        ...
        _trackContentView.image = [UIImage imageNamed:@"gift_track_background" bundleName:@"LiveRoomUI"];

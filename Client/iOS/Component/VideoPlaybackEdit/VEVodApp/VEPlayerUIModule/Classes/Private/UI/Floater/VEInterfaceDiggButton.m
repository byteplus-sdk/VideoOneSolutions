...
- (void)setLiked:(BOOL)liked {
    ...
    if (self.axis == UILayoutConstraintAxisVertical) {
        ...
        imageView.image = [UIImage imageNamed:liked ? @"vod_liked_deformity" : @"vod_like_deformity"];
    }
}
...
+ (void)playDiggAnimationInView:(UIView *)containerView location:(CGPoint)location {
    UIImageView *view = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"vod_heart"]];

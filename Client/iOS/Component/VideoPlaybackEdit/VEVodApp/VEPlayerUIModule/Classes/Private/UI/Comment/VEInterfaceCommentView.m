...
- (void)changeScreenClearState:(BOOL)isClear {
    if (self.eventPoster) {
        ...
        [self.eventMessageBus postEvent:VEUIEventScreenClearStateChanged withObject:nil rightNow:YES];
    }
}
...
- (void)createTableView {
    ...
    [tableView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.leading.trailing.equalTo(self.contentView);
        make.bottom.equalTo(self.contentView).offset(-[DeviceInforTool getVirtualHomeHeight] - self.viewDesc.inputHeight);
    }];

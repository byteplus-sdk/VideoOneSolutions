...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([item.itemAction isEqualToString:VEPlayEventChangeResolution]) {
        ...
        if ([item.actionParam isKindOfClass:[SubtitleidType class]]) {
            SubtitleidType *subtitle = (SubtitleidType*)item.actionParam;
            VEInterfaceSmartSubtitleConf *sutitleScene = (VEInterfaceSmartSubtitleConf *)self.scene;
            NSInteger currentLanguangeId = sutitleScene.manager.currentSubtitleId;
            cell.highlightBackgroundView.hidden = !(subtitle.subtitleId == currentLanguangeId);
        }
    }
    return cell;
}

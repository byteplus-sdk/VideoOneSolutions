    ...
    return ({
        ...
        reportDes.elementDisplay = ^(__kindof VEInterfaceSlideButtonCell *cell) {
            ...
            if (!weak_self.skipPIPMode) {
                ...
                [pipButton bingImage:[UIImage imageNamed:@"vod_pip_icon"] status:ButtonStatusNone];
                [pipButton bingImage:[UIImage imageNamed:@"vod_pip_icon_s"] status:ButtonStatusActive];
                [pipButton setTitle:LocalizedStringFromBundle(@"vod_pip", @"VEVodApp") forState:UIControlStateNormal];
            ...
            [reportButton setTitle:LocalizedStringFromBundle(@"vod_report", @"VEVodApp") forState:UIControlStateNormal];
...
- (VEInterfaceElementDescriptionImp *)pipButton {
    ...
    return ({
        ...
        pipButtonDes.elementDisplay = ^(VEActionButton *button) {
            [button setImage:[UIImage imageNamed:@"vod_pip_icon"] forState:UIControlStateNormal];
            [button setImage:[UIImage imageNamed:@"vod_pip_icon_s"] forState:UIControlStateSelected];
            button.hidden = YES;

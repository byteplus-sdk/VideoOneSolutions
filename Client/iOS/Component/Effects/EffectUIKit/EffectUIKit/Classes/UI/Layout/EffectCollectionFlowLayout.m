...
@interface EffectCollectionFlowLayout ()

@property (nonatomic, assign, readonly) BOOL isHorizontal;

@end

@implementation EffectCollectionFlowLayout

- (void)setMode:(EffectUIKitCollectionLayoutMode)mode {
    _mode = mode;
...
- (NSArray<__kindof UICollectionViewLayoutAttributes *> *)layoutAttributesForElementsInRect:(CGRect)rect {
    ...
    if (_mode == EffectUIKitCollectionLayoutModeLeft) {
        return attrs;
    }
...
- (void)resetLineAttr:(NSArray<UICollectionViewLayoutAttributes *> *)attrs {
    ...
    if (_mode == EffectUIKitCollectionLayoutModeCenter) {
    ...
    } else if (_mode == EffectUIKitCollectionLayoutModeExpand) {

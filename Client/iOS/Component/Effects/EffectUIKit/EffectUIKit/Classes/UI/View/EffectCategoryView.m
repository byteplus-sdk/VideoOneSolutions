...
@interface EffectCategoryView () <UICollectionViewDelegateFlowLayout>

@property (nonatomic, strong) EffectSwitchTabView *tabView;
...
@implementation EffectCategoryView
...
#pragma mark - getter
- (EffectSwitchTabView *)tabView {
    if (!_tabView) {
        _tabView = [[EffectSwitchTabView alloc] initWithTitles:@[]];
...
#pragma mark - setter
- (void)setTabDelegate:(id<EffectUIKitSwitchTabViewDelegate>)tabDelegate {
